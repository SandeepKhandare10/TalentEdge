          ...
          <div className="col-lg-9 col-md-11 col-sm-12 col-12 mx-auto">
            <div className="layout-box px-5 py-3">
              ...
              <div className="qest-title">
                <h3>Career Assessment 2 to 5</h3>
              </div>
                      ...
                      <table className="table mb-0">
                        ...
                        <tbody>
                          {[
                            {
                              question:
                                "Going to work makes me extremely happy and I thoroughly enjoy my current work.",
                              rangeName: "range1",
                              questionId: 1,
                            ...
                            {
                              question:
                                "I am extremely happy and satisfied with my current salary and compensation.",
                              rangeName: "range2",
                              questionId: 2,
                            ...
                            {
                              question:
                                "I am proud that I have achieved my career goals which I dreamt of two to three years ago.",
                              rangeName: "range3",
                              questionId: 3,
